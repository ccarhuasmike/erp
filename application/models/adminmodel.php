...
class AdminModel extends CI_Model
{
    ...
    public function Obtener($id)
    {
        //$this->db->where('Empresa_id', $this->user->Empresa_id);
        //$this->db->where('id', $id);
        $u = $this->db->get('configuracion')->row();
        return   $u;// $this->db->get('configuracion')->row();
    }
    ...
    public function Listar()
    {
        ...
        //$this->db->where($where);
		$this->jqgridmodel->Config($this->db->SELECT('COUNT(*) Total FROM configuracion')->get()->row()->Total);
