  ...
  <body>
    ...
    <div class="container">
						  ...
						  <div class="panel-body">
							<?php echo form_open('acceso/ajax/Acceder', array('class' => 'upd form-horizontal')); ?>
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							        <input type="text" name="Ruc" class="form-control required" placeholder="Ingrese su Ruc" value="<?php if(IS_DEMO == 1) echo 'demo'; ?>" />
                                </div>
							  </div>
							  <div class="form-group">
							    <label for="inputEmail3" class="col-sm-2 control-label">Usuario</label>
							    <div class="col-sm-10">
							      <input type="text" name="Usuario" class="form-control required" placeholder="Ingrese su nombre de Usuario" 
							      value="<?php if(IS_DEMO == 1) echo 'demo'; ?>" />
							    </div>
							  </div>
							  <div class="form-group">
		...
		<footer class="text-center">
			<hr />
			<img src="<?php echo base_url('assets/bootstrap/css/light/images/logoD.png'); ?>" alt="Ventor" />
	    </footer>
