		<footer class="text-right">
			<hr />
			<img src="<?php echo base_url('assets/bootstrap/css/light/images/logoD.png'); ?>" alt="Ventor" width="150" /><br />
	    	Desarrollado por el equipo <a target="blank" href="http://www.digiflow.pe">Digiflow</a><br /><br />
